...
> [!IMPORTANT]
>**An incompatibility with the M4 board has been reported. This is the Readme for a new PCB version that will work properly with the M4 without manual modifications.**
> See Issues for link to more details. 
>**JED files and PCB have not been released yet as testing is not finished yet.** Also pictures need to be updated to reflect the new PCB. 
